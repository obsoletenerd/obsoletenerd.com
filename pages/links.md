...
[Godot](https://godotengine.org) - Pronounced "godot" (like "gif" is pronounced "gif"). Open-source and completely free to use, Godot is an impressively powerful 2D and 3D game development engine that often gets buried under the shadows of the large commercial ones, and yet is fully capable of building release-level games, while being way easier to learn too. Also a really useful tool for making small native GUI applications that work cross-platform.

[Blender](https://www.blender.org) - Most people who use computers have heard of Blender, but still very few understand how easy and fun it can be just to create "something". Follow a few tutorials and you'll be making incredible 3D art and/or animations in no time. It's easy to get daunted by what the pros are doing with it, but it's also just extremely fun to play around with. Model your room/house and play with furniture layouts. Do some 3D sculpting of virtual clay. Animate text. Make particle effects like fireworks made of donuts. So many donuts.
...
[VLC](https://www.videolan.org/vlc/) - If you're using anything other than VLC to watch videos on your devices, you're doing it wrong. Stop wrestling with the horrible built-in video applications in your OS and just use VLC for everything. It plays every format you'll ever need, it converts, it plays music files and DVD rips, it handles subtitles and syncing subs, and it can stream digital radio stations. All for free.

[OBS Studio](https://obsproject.com) - Hugely underrated piece of software that most people think is "just for Twitch streamers" but is actually a full free and open-source video/audio/graphics recording/streaming/processing pipeline. Add graphics over videos, mix multiple audio channels over a video/stream, record videos from multiple physical or virtual sources, record your screen but add overlays, and so much more.
